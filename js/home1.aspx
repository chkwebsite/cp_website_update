...
<html lang="en"><head>
    ...
    <link href="./base-responsive.css" rel="stylesheet" media="all">
    <link href="./flexslider.css" rel="stylesheet" media="all">
    <link href="./megamenu.css" rel="stylesheet" media="all">
    <!-- Theme styles for this template -->
    <link href="./megamenu.css" rel="stylesheet" media="all">
    <link href="./site.css" rel="stylesheet" media="all">
    <link href="./site-responsive.css" rel="stylesheet" media="all">
    <link href="./print(1).css" rel="stylesheet" type="text/css" media="print">
                     ...
                     <div class="common-right clearfix">
                        <ul id="header-nav">
                           ...
                           <li class="ico-site-search cf  ">
                              ...
                              <img class="top" src="./ico-site-search.png" alt="Site Search"></a>
                           ...
                           <li class="ico-accessibility cf">
                              ...
                              <img class="top" src="./ico-accessibility.png" alt="Accessibility Dropdown">
                              </a>
                           ...
                           <li class="ico-social cf">
                              ...
                              <img class="top" src="./ico-social.png" alt="Social Medias"></a>
                              <ul style="visibility: hidden;">
                                 <li><a target="_blank" title="External Link that opens in a new window" href="http://www.facebook.com/"><img alt="Facebook Page" src="./ico-facebook.png"></a></li>
                                 <li><a target="_blank" title="External Link that opens in a new window" href="http://www.twitter.com/"><img alt="Twitter Page" src="./ico-twitter.png"></a></li>
                                 <li><a target="_blank" title="External Link that opens in a new window" href="http://www.youtube.com/"><img alt="youtube Page" src="./ico-youtube.png"></a></li>
                              </ul>
                           </li>
                           <li class="ico-sitemap cf"><a href="https://uxdt.nic.in/wp-content/uploads/templates/template19/home.html" title="Sitemap">
                              <img class="top" src="./ico-sitemap.png" alt="Sitemap"></a>
                           </li>
               ...
               <div class="header-right clearfix">
                  <div class="right-content clearfix">
                     <div class="float-element">
                        <a class="sw-logo" target="_blank" href="https://swachhbharat.mygov.in/" title="Swachh Bharat, External link that open in a new windows"><img src="./swach-bharat.png" alt="Swachh Bharat"></a>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="minister-box clearfix">
                     <div class="minister-sub1">
                        ...
                        <div class="min-info">
                           ...
                           <h5 class="prime"><a href="#" title="Hon’ble Prime Minister">माननीय नगर विकास मंत <br> (उत्तर प्रदेश)</a></h5>
                     ...
                     <div class="minister-sub">
                        ...
                        <div class="min-info">
                           <h5><a href="#" title="Minister of State"><span>वार्ष्णेय भारतीय जनता पार्टी, नगर पंचायत अध्यक्ष - बबराला</span>
                              हर्ष वर्धन </a>
                           </h5>
                        </div>
                     </div>
                              ...
                              <div class="resp-tabs-container hor_1" style="border-color: rgb(76, 77, 82);">                           
                                 <h2 class="resp-accordion hor_1 resp-tab-active" role="tab" aria-controls="hor_1_tab_item-0" style="background: none;"><span class="resp-arrow"></span><a href="#" id="tab-list-1"> Whats's New</a></h2><div class="clearfix resp-tab-content hor_1 resp-tab-content-active" id="hor_1_tab_item-0" aria-labelledby="hor_1_tab_item-0" style="display:block">
                                    <div class="content-wrapper">
                                       ...
                                       <div class="view-footer"><a href="https://uxdt.nic.in/mpa/media/whats-new" title="Read More"><span>Read More &gt;</span></a></div>
                                    </div>
                                 </div>
  ...
  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"><ul class="list">
   <li>                                                
                  ...
                  <ul class="content_list date-list">
                     <li>
                        <a href="#" title="schemes/ services/ event/ activity ">
                           <div class="date"><span><img src="./01.png" alt="schemes/ services/ event/ activity "></span></div>
                           <div class="list-content"><p>योजनाएं/सेवाएं/घटना/गतिविधि </p></div>
                        </a>
                     </li>
                     <li>
                        <a href="#" title="schemes/ services/ event/ activity ">
                           <div class="date"><span><img src="./02.png" alt="schemes/ services/ event/ activity "></span></div>
                           <div class="list-content"><p>योजनाएं/सेवाएं/घटना/गतिविधि </p></div>
                        </a>
                     </li>
                     <li>
                        <a href="#" title="schemes/ services/ event/ activity ">
                           <div class="date"><span><img src="./03.png" alt="schemes/ services/ event/ activity "></span></div>
                           <div class="list-content"><p>योजनाएं/सेवाएं/घटना/गतिविधि </p></div>
                        </a>
                     </li>
                     <li>
                        <a href="#" title="schemes/ services/ event/ activity">
                           <div class="date"><span><img src="./04.png" alt="schemes/ services/ event/ activity "></span></div>
                           <div class="list-content"><p>योजनाएं/सेवाएं/घटना/गतिविधि</p></div>
                        </a>
                     </li>
                  </ul>
            ...
            <div class="container common-container four_content gallery-container">
               <div class="gallery-area clearfix">
                  ...
                  <div class="gallery-holder">
                     ...
                     <ol class="flex-control-nav flex-control-thumbs"><li><img src="images/HV5.jpg" alt="Slide 1" class="" draggable="false"></li><li><img src="images/HV2.jpg" alt="Slide 2" draggable="false" class="flex-active"></li><li><img src="images/HV4.jpg" alt="Slide 3" draggable="false" class=""></li></ol>
                  ...
                  <div class="video-wrapper">
                     <video src="" poster="theme/images/" title="The Union Minister for Railways and Coal, Shri Piyush Goyal addressing a press conference on Neyveli Lignite Corporation." class="has-media-controls-hidden">
                        <span>Your browser does not support HTML5 video.</span>
                                      ...
                                      <svg class="video-overlay-play-button" viewBox="0 0 200 200" alt="Play video">                        <circle cx="100" cy="100" r="90" fill="none" stroke-width="15" stroke="#fff"></circle>                        <polygon points="70, 55 70, 145 145, 100" fill="#fff"></polygon>                    </svg>                    </div>
               </div>
            </div>
         </div>
      </section>
      ...
      <section class="wrapper carousel-wrapper">
         ...
         <div class="container common-container four_content carousel-container">
            ...
            <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(-72px, 0px, 0px);">
                  <li style="width: 200px; margin-right: 5px; float: left; display: block;"><a target="_blank" href="http://digitalindia.gov.in/" title="Digital India, External Link that opens in a new window"><img src="./digital-india.png" alt="Digital India" draggable="false"></a></li>
                  <li style="width: 200px; margin-right: 5px; float: left; display: block;"><a target="_blank" href="http://www.makeinindia.com/" title="Make In India, External Link that opens in a new window"> <img src="./makeinindia.png" alt="Make In India" draggable="false"></a></li>
                  <li style="width: 200px; margin-right: 5px; float: left; display: block;"><a target="_blank" href="http://india.gov.in/" title="National Portal of India, External Link that opens in a new window"><img src="./india-gov.png" alt="National Portal of India" draggable="false"></a></li>
                  <li style="width: 200px; margin-right: 5px; float: left; display: block;"><a target="_blank" href="http://goidirectory.nic.in/" title="GOI Web Directory, External Link that opens in a new window"><img src="./goidirectory.png" alt="GOI Web Directory" draggable="false"></a></li>
                  <li style="width: 200px; margin-right: 5px; float: left; display: block;"><a target="_blank" href="https://data.gov.in/" title="Data portal, External Link that opens in a new window"><img src="./data-gov.png" alt="Data portal" draggable="false"></a></li>
                  <li style="width: 200px; margin-right: 5px; float: left; display: block;"><a target="_blank" href="https://mygov.in/" title="MyGov, External Link that opens in a new window"><img src="./mygov.png" alt="MyGov Portal" draggable="false"></a></li>
         ...
         <div class="footer-bottom-wrapper">
            <div class="container common-container four_content footer-bottom-container">
               <div class="footer-content clearfix">
                  ...
                  <div class="logo-cmf"> <a target="_blank" href="http://cmf.gov.in/" title="External link that opens in new tab"><img alt="cmf logo" src="./cmf-logo.png"></a> </div>
               </div>
            </div>
         </div>
      </footer>
      <!--/.footer-wrapper-->
       <script src="./jquery-2.1.1.min.js.download"></script>
      <script src="./jquery-accessibleMegaMenu.js.download"></script>
      <script src="./jquery.flexslider.js.download"></script>
      <script src="./megamenu.js.download"></script>
      <script src="./easyResponsiveTabs.js.download"></script>
